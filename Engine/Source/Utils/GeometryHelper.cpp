...
void GeometryHelper::CreateQuad(const shared_ptr<Geometry<VertexColorData>>& geometry, Color color)
{
...
void GeometryHelper::CreateCube(const shared_ptr<Geometry<VertexTextureData>>& geometry)
{
	float w2 = 0.5f;
	float h2 = 0.5f;
	float d2 = 0.5f;
...
void GeometryHelper::CreateSphere(const shared_ptr<Geometry<VertexTextureData>>& geometry, uint32 stackCount, uint32 sliceCount)
{
...
void GeometryHelper::CreateGrid(const shared_ptr<Geometry<VertexTextureData>>& geometry, int32 sizeX, int32 sizeZ)
{
	vector<VertexTextureData> vtx;
...
void GeometryHelper::CreateQuad(const shared_ptr<Geometry<VertexTextureNormalData>>& geometry)
{
...
void GeometryHelper::CreateCube(const shared_ptr<Geometry<VertexTextureNormalData>>& geometry)
{
	float w2 = 0.5f;
	float h2 = 0.5f;
	float d2 = 0.5f;
...
void GeometryHelper::CreateGrid(const shared_ptr<Geometry<VertexTextureNormalData>>& geometry, int32 sizeX, int32 sizeZ)
{
	vector<VertexTextureNormalData> vtx;
...
void GeometryHelper::CreateSphere(const shared_ptr<Geometry<VertexTextureNormalData>>& geometry)
{
	float radius = 0.5f; // ±∏¿« π›¡ˆ∏ß
...
void GeometryHelper::CreateQuad(const shared_ptr<Geometry<VertexTextureNormalTangentData>>& geometry)
{
...
void GeometryHelper::CreateCube(const shared_ptr<Geometry<VertexTextureNormalTangentData>>& geometry)
{
	float w2 = 0.5f;
	float h2 = 0.5f;
	float d2 = 0.5f;
...
void GeometryHelper::CreateGrid(const shared_ptr<Geometry<VertexTextureNormalTangentData>>& geometry, int32 sizeX, int32 sizeZ)
{
	vector<VertexTextureNormalTangentData> vtx;
...
void GeometryHelper::CreateSphere(const shared_ptr<Geometry<VertexTextureNormalTangentData>>& geometry)
{
	float radius = 0.5f; // ±∏¿« π›¡ˆ∏ß
	uint32 stackCount = 20; // ∞°∑Œ ∫–«“
	uint32 sliceCount = 20; // ºº∑Œ ∫–«“
